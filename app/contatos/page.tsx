     ...
     <div className="contacts-inner">
       ...
       <div className="contacts-toolbar">
         <div className="contacts-filters">
           <button className="pill active">Todos (24)</button>
           <button className="pill"><i className="online-dot"/>Online (8)</button>
           <button className="pill"><Star size={15}/>Favoritos (5)</button>
       ...
       <div className="contacts-row">
         {contacts.map(c=><article className="contact-card" key={c.name} tabIndex={0}>
         ...
         <button className="invite-card"><Plus/><span>Convidar alguém<br/>para ZYVO</span></button>
       </div>
